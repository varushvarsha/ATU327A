...
namespace __xsepower { // who is xsepower?
	...
	std::size_t const count_size = 16*cores; /*** adjust this number according to number of threads available per core */
	...
	/* display what has been downloaded (this functionality is only for 
	 * low load demonstration). */
